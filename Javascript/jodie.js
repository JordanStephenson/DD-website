...
if(galleryImages) {
    galleryImages.forEach(function(image,index) {
        image.addEventListener('click', () => {
            ...
            let getImgUrlPos = getFullImgUrl.split('IMG/jodie-thumb');
            ...
            newImg.setAttribute('src', '../IMG/jodie-img' + setNewImgUrl);
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute('src', '../IMG/jodie-img/img' + calcNewImg + '.png');
    newImg.setAttribute('id', 'current-img');
